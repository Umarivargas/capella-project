...
namespace MvcEtfApi1.Controllers
{
    public class ObjetivosProyectosController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetObjetivosProyecto(int id)
        {
            ObjetivosProyecto objetivosProyecto = await db.ObjetivosProyectoes.FindAsync(id);
        ...
        public async Task<IHttpActionResult> PutObjetivosProyecto(int id, ObjetivosProyecto objetivosProyecto)
        {
        ...
        [ResponseType(typeof(ObjetivosProyecto))]
        public async Task<IHttpActionResult> PostObjetivosProyecto(ObjetivosProyecto objetivosProyecto)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [ResponseType(typeof(ObjetivosProyecto))]
        public async Task<IHttpActionResult> DeleteObjetivosProyecto(int id)
        {
            ObjetivosProyecto objetivosProyecto = await db.ObjetivosProyectoes.FindAsync(id);
            if (objetivosProyecto == null)
            {
