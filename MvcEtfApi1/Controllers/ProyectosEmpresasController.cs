...
namespace MvcEtfApi1.Controllers
{
    public class ProyectosEmpresasController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetProyectosEmpresa(int id)
        {
            ProyectosEmpresa proyectosEmpresa = await db.ProyectosEmpresas.FindAsync(id);
        ...
        public async Task<IHttpActionResult> PutProyectosEmpresa(int id, ProyectosEmpresa proyectosEmpresa)
        {
        ...
        [ResponseType(typeof(ProyectosEmpresa))]
        public async Task<IHttpActionResult> PostProyectosEmpresa(ProyectosEmpresa proyectosEmpresa)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [ResponseType(typeof(ProyectosEmpresa))]
        public async Task<IHttpActionResult> DeleteProyectosEmpresa(int id)
        {
            ProyectosEmpresa proyectosEmpresa = await db.ProyectosEmpresas.FindAsync(id);
            if (proyectosEmpresa == null)
            {
